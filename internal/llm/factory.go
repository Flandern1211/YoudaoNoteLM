...
func NewChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ChatModel, error) {
	if cfg == nil {
...
func NewToolCallingChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ToolCallingChatModel, error) {
...
func newArkChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ChatModel, error) {
...
func newDeepSeekChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ChatModel, error) {
...
func newOpenAIChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ChatModel, error) {
...
func newQianwenChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ChatModel, error) {
...
func newAnthropicChatModel(ctx context.Context, cfg *entity.UserConfig) (model.ChatModel, error) {
